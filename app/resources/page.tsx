...
const STORIES = [
  { title: "From drought to abundance: How Savita transformed her village's water crisis", category: 'Water Conservation', date: 'January 2024', excerpt: "In a village that once walked kilometres for water, Savita and her women's group led the construction of a check dam that now sustains 300 families year-round." },
  { title: 'First in her family to complete Class 10: Rekha's education journey',           category: 'Education',          date: 'December 2023', excerpt: "Growing up in a migrant tribal family, Rekha faced every obstacle imaginable. AROEHAN's scholarship and tutoring support helped her break the cycle." },
  { title: 'Rice Mill cooperative gives landless women a steady income',                    category: 'Livelihood',         date: 'November 2023', excerpt: 'Twelve women from a Vikramgad village pooled their efforts to run a rice mill — now generating consistent monthly income for each family.' },
];
